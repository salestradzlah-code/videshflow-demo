...
export const metadata: Metadata = {
  ...
  description: "How VideshFlow may collect and use relocation request information.",
};
...
const sections = [
  ...
  { title: "Why data is collected", text: "To respond to requests, improve country guides, build anonymized relocation content, and connect users with relevant service categories or providers where consent is given." },
  ...
  { title: "Provider connection consent", text: "VideshFlow should only connect users with providers where the user has agreed to be contacted or has asked for service options." },
  ...
  { title: "Contact", text: `For privacy questions, contact ${CONTACT_EMAIL}. This is a placeholder email until the production contact channel is finalized.` },
];
      ...
      <div className="mx-auto max-w-4xl">
        <div className="rounded-[2rem] bg-white p-8 shadow-sm sm:p-12">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-600">
            This simple launch policy explains the type of information VideshFlow may collect through forms, story submissions, and future help requests.
          </p>
        </div>
