...
export const metadata: Metadata = {
  ...
  description: "Tell VideshFlow what relocation help you need beyond country guides.",
};
...
const categories = [
  ...
  "Indian groceries and community",
...
const steps = [
  ...
  { title: "Get routed to resources", text: "VideshFlow can point you to country guides, checklists, service categories, or future AI triage paths." },
  { title: "Provider connection later", text: "Where you consent, VideshFlow may connect you with relevant service providers for your own review." },
];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="rounded-[2rem] bg-white p-8 shadow-sm sm:p-12">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
            VideshFlow is not built around manual consulting as the main model. This is a scalable request intake flow that can later connect to AI triage, planning resources, and service categories or providers for your review.
          </p>
        ...
        <div className="mt-8 rounded-[2rem] bg-white p-8 shadow-sm sm:p-10">
          ...
          <p className="mt-3 text-sm leading-7 text-slate-600">
            Destination, move reason, and family profile help VideshFlow route users to the correct playbook, AI checklist, service category, or provider option for review.
          </p>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] bg-white p-8 shadow-sm">
              <Route className="h-7 w-7 text-[#123638]" />
              <h2 className="mt-5 text-2xl font-semibold text-[#172326]">How VideshFlow handles your request</h2>
