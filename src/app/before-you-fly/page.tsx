...
export const metadata: Metadata = {
  title: "Before You Fly From India",
  description: "A practical pre-departure checklist for Indians moving abroad.",
};
...
const sections = [
  ...
  { icon: Shirt, title: "Clothes and office wear", items: ["Buy formal office wear if cheaper in India", "Business suits, ties, formal shirts, belts, and formal shoes", "Weather clothing based on destination, including winter wear, rainwear, or breathable tropical clothing", "Comfortable walking shoes for commute and arrival errands"] },
  ...
  { icon: BriefcaseBusiness, title: "Driving, money, and phone", items: ["Driving licence and IDP research", "Forex, cards, and emergency cash planning", "Indian SIM, OTP, and bank access plan", "Backup phone or eSIM research where useful"] },
    ...
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="rounded-[2rem] bg-white p-8 shadow-sm sm:p-12">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-tight text-[#172326] sm:text-5xl">Before You Fly From India</h1>
          <p className="mt-5 max-w-4xl text-lg leading-8 text-slate-600">
            A practical pre-departure checklist for documents, clothes, medicines, driving, phone OTPs, baggage, and family records before moving abroad.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link href="/countries" className="inline-flex items-center rounded-full bg-[#123638] px-6 py-3 text-sm font-semibold text-white hover:bg-[#0c2829]">
              Open country guides <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
